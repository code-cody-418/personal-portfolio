...
export const MyModal = () => {
  ...
  console.log("allModalInfo", allModalInfo);
  ...
  let previousItemInfo = allListItems
    ? allListItems[currentItemIndex - 1]
    : null;
          ...
          <Container>
            {allModalInfo?.contactForm ? ( // if contactForm display contact form contents
              ...
              <>
                <Row>
                  <Col xs={12} md={8}>
                    <p className="modal-body">{allModalInfo?.description}</p>
                  </Col>
                  <Col xs={12} md={4} className="my-auto d-block">
                    {allModalInfo?.img ? (
                      <Image
                        src={allModalInfo?.img}
                        alt={allModalInfo?.img}
                        roundedCircle={allModalInfo.roundImg}
                        fluid
                      />
                    ) : null}
                    {allModalInfo?.threeLogo ? (
                      <ThreeLogo threeLogo={allModalInfo?.threeLogo} />
                    ) : null}
