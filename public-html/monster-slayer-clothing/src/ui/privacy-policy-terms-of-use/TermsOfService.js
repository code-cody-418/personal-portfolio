  ...
  return (
    <>
      <Container>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Monster Slayer Clothing Bank.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Monster Slayer Clothing Bank,
              accessible from{" "}
              <a
                href="https://monsterslayer.org/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://monsterslayer.org/
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            <p>By email: monsterslayerclothingbank@gmail.com</p>
          </li>
          <li>
            <p>
